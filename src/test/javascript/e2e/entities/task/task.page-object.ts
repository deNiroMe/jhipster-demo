...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipsterDemoApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipsterDemoApp.task.delete.question/);
